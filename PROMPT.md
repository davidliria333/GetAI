# TASK: Redesign AnalitikAI website to world-class level

## What I need
Rewrite `index.html` completely. I want a website that looks like it cost $100,000 to build. Not a template. Not AI-generated looking. A genuinely premium, hand-crafted feeling website.

## Reference sites for design quality (NOT to copy, just for quality level):
- stripe.com (typography, spacing, polish)
- linear.app (dark theme, smooth animations, developer-grade craft)
- vercel.com (clean, modern, confident)
- setup-ai.com (storytelling structure, conversational copy)
...
6. **Structure**:
   ...
   - Final CTA section
   - Footer (minimal)
7. **CTA everywhere**: https://cal.eu/getaibase/demo — "Reserva una consulta" or "Habla con nosotros"
...
- Be conversational but professional (like a smart partner talking to another partner)
- Avoid buzzwords ("leveraging AI", "cutting-edge", "revolutionary")
- Use specific numbers where possible (48h delivery, 85% time saved)
...
- Add cookie banners or popups
- Use Lorem Ipsum anywhere
- Make it look like a Webflow template
- Use more than 2 fonts
- Add unnecessary decorative elements

Make it EXCEPTIONAL. I want someone to land on this page and think "whoever built this really knows what they're doing."
